...
! function(j) {
    ...
    function Ig(e, r, o, i, a) {
        ...
        return "none" !== r.remove ? (function(t, e, n) {
            ...
            })) : i.isBlock(e) && !i.isBlock(o) && (Vg(i, e, !1) || Vg(i, e.firstChild, !0, 1) || e.insertBefore(i.create(""), e.firstChild), Vg(i, e, !0) || Vg(i, e.lastChild, !1, 1) || e.appendChild(i.create("")))), n.selector && n.inline && !Zg(n.inline, e) || i.remove(e, 1)
        }(e, i, r), !0) : void 0
    }
    ...
    function JC(e, t) {
        ...
        }(e.schema, s, l) && (n = i.create(""), a.insertNode(n), a.setStartAfter(n), a.setEndAfter(n), r = !0), n = i.create(""), Xu(i, a, n), YC(i, o, n), GC(i, o, n, r), e.undoManager.add()
    }
